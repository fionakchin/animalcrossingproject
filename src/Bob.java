...
public class Bob implements AnimatingEntities, MovingEntities, ExecutingEntities{
    ...
    public Bob(String id, Point position, List<PImage> images, double actionPeriod, double animationPeriod) {
        this.id = id;
    ...
    public void executeActivity (WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        if (fairyTarget.isPresent()) {
            ...
            if (moveTo(world, fairyTarget.get(), scheduler)) {
                ...
                Sapling sapling = Functions.createSapling(Functions.getSaplingKey() + "_" + fairyTarget.get().getId(), tgtPos, imageStore.getImageList(Functions.getSaplingKey()), 0);
